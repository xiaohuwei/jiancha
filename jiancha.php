...
function getspider($useragent=''){
    ...
    if (strpos($useragent, 'addsugarspiderbot') !== false){return 'AddSugarSpiderBot';} 
...
<h1 style='text-align:center'>
  <span style='color:rgb(255, 255, 255);font-family:'Microsoft YaHei''>欢迎驾临肖虎威博客</span></h1>
<blockquote>
  <p style='text-align:center'>
    <span style='font-size:14pt;font-family:'comic sans ms',sans-serif'>
      <span style='color:rgb(255, 255, 255);font-family:'Microsoft YaHei'; font-size:15px;'>正在检查您的浏览器和网络环境，<span id=\"mes\">5</span> 秒&nbsp;</span>
  </p>
</blockquote>
</body>
</html>
